...
function Register() {
    ...
    const onSubmit = async (values, { setSubmitting, resetForm }) => {
        try {
            const register = await axios.post(`${config.API_URL}/landing/register`, values);
            if (register) {
                const myToast = register.data && register.data && register.data.code == "duplicate" ? toast.warning : toast.success;
    ...
    return (
        <>
                        ...
                        <Form>
                            ...
                            <div className="mb-4 position-relative">
                                <Field
                                    ...
                                    required=""
                                />
                                <ErrorMessage name="password" render={(msg) => <small className='text-danger'>{msg}</small>}></ErrorMessage>
                            ...
                            <button className="btn btn-lg btn-primary w-100" disabled={!(dirty && isValid)}>
                                Sign Up
                            </button>
            ...
            <div className="row row-cols-1 row-cols-sm-2 gy-3">
                <div className="col">
                    <button className="btn btn--googleplus w-100 font--medium"
                        onClick={googleAuth}
                    >
                ...
                <div className="col">
                    <button className="btn btn--facebook w-100 font--medium"
