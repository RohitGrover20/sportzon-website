        ...
        <div className="container">
          <div className="row justify-content-between">
            <div className="col-lg-4 pe-xl-5 pe-lg-4 text-white">
              ...
              <div className="card border-0 p-4 rounded-3" style={{backgroundColor:"#05395F"}}>
                <h2 className="h4 text-dark font--bold mb-4 text-white">India</h2>
                <ul className="p-0 m-0 ">
                  <li className="d-flex mb-3">
                    <i className="fa-solid fa-phone text-white fs-5 me-2" />
                    <a className="text-white" href="tel:011-45613001">
                      011-45613001
                    </a>
                  </li>
                  <li className="d-flex mb-3">
