...
function Registration(props) {
	...
	const onSubmit = async (values, { setSubmitting, resetForm }) => {
		...
		if (user && user.code == "unauthorised") {
			...
			axios
				.post(`${config.API_URL}/landing/payments/orders`, _data, { withCredentials: true })
				.then((res) => {
				...
				<>
					<div className="modal-header">
						<div className="mdl-title mb-1">
							...
							<p>
								Please book for your {event.eventType} by filling the form below, specify the expected
								number joining the {event.eventType}.
							</p>
						</div>
					</div>
					<div className="modal-body">
											...
											<Form className="row">
												...
												<div className="form-group mt-2">
													...
													<span htmlFor="flexCheckDefault">
														I understand that I am responsible for reading and understanding
														the terms and conditions of the event or service I am
														registering for.
													</span>
												</div>
