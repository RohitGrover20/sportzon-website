            ...
            <div className="container">
                ...
                <div className="row justify-content-between mb-5">
                    <div className="col-xl-6 col-lg-6 col-md-5 mb-3 mb-md-0">
                        <img src={`${config.API_URL}/events/${event && event.banner}`} className='w-100 rounded shadow-sm' />
                    </div>
                    <div className="col-xl-6 col-lg-6 col-md-7 col-xl-5 px-xl-5">
                        ...
                        <div className="d-flex align-items-center pt-3 py-2">
                            ...
                            <p className='text-primary m-0'><i className='fa fa-calendar' /> {new Date(event.eventDate).toDateString()}  {event.eventTime && event.eventTime.from} to {event.eventTime && event.eventTime.to}</p>
                            {/* <span className="font--medium">V00273124</span> */}
                        </div>
                        {/* Item Title */}
                        <h1 className=" pb-0 mb-0 lh-base" style={{ fontSize: "30px" }}>{event && event.title}</h1>
                        <p className="mb-4 text-muted">
                            <a href={`http://maps.google.com/?q=${event && event.address}`} target="_blank"><i className='fa fa-map' /> {event && event.address}</a>
                        </p>

                        <div className="d-none d-md-flex align-items-center pb-3 mb-1">

                            <button type="button" className="btn btn-outline-dark disabled me-2">
            ...
            >
                ...
                >
                    <div className="modal-content" id="eventRegistrationModal">
                        <span className="mod-close" data-bs-dismiss="modal" aria-hidden="true" id="registrationClose">
