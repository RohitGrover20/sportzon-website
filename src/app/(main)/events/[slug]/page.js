	...
	return (
		<section className="gray-simple">
					...
					<div className="col-xl-6 col-lg-6 col-md-7 col-xl-5 px-xl-5">
						...
						<div className="d-flex align-items-center pt-3 py-2">
							...
							<p className="text-primary m-0">
								<i className="fa fa-calendar" /> {new Date(event.eventDate).toDateString()}{" "}
								{event.eventTime && event.eventTime.from} to {event.eventTime && event.eventTime.to}
							</p>
						...
						<p className="mb-4 text-muted">
							<a href={`http://maps.google.com/?q=${event && event.address}`} target="_blank">
			...
			<div
				...
				aria-hidden="true"
			>
				<div className="modal-dialog modal-dialog-centered login-pop-form modal-md" role="document">
