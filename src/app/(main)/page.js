							...
							<div className="position-relative exloi py-lg-0 pb-4">
								<div className="exloi-caption">
									...
									<p className="mb-0 fs-5 fw-light">
										We bring together venues, coaches, events, tournaments, marathons, and a host of
										incredible features to revolutionize your sporting journey.
									</p>
											...
											<div className="col-sm-12 ps-0">
												<div className="d-flex align-items-start mb-3">
													...
													<div className="ps-3">
														<h5>Convenience</h5>
														<p>
															Finding and booking sports venues or coaches is just a few
															clicks away with our user-friendly interface.
														</p>
													</div>
												</div>
												<div className="d-flex align-items-start mb-3">
													...
													<div className="ps-3">
														...
														<p>
															We cater to a wide range of sports and activities, ensuring
															that every enthusiast finds their perfect match on SportZon.
														</p>
													</div>
												</div>
												<div className="d-flex align-items-start mb-3">
													...
													<div className="ps-3">
														...
														<p>
															Take advantage of our exclusive coupons and discounts to
															elevate your sports experience without breaking the bank.
														</p>
													</div>
												</div>
												<div className="d-flex align-items-start">
													...
													<div className="ps-3">
														...
														<p>
															Connect with like-minded individuals, athletes, and coaches,
															fostering a vibrant sports community.
														</p>
													</div>
												</div>
											</div>
					...
					<div className="row align-items-center justify-content-center">
						<div className="col-xl-7 col-lg-7 col-md-11 mb-3">
							<div className="sec-heading text-center">
								...
								<p className="test-muted fs-6">vero accusamus et iusto odio dignissimos ducimus</p>
							</div>
						</div>
					</div>
								...
								<div className="row align-items-center">
									...
									<div className="col-sm-9 col-9">
										<div className="hgh-features-captions py-3 pe-3">
											...
											<p className="m-0">
												SportZon provides a complete and diverse sports ecosystem, bringing
												together venues, coaches, events, tournaments, and marathons all in one
												platform. Say goodbye to multiple searches and embrace the convenience
								...
								<div className="row align-items-center">
									...
									<div className="col-sm-9 col-9">
										<div className="hgh-features-captions py-3 pe-3">
											...
											<p className="m-0">
												Explore a curated selection of top-notch sports venues, ensuring you
												have access to the best facilities for your favourite sports activities.
											</p>
										</div>
									</div>
								</div>
								...
								<div className="row align-items-center">
									...
									<div className="col-sm-9 col-9">
										<div className="hgh-features-captions py-3 pe-3">
											...
											<p className="m-0">
												Connect with experienced and qualified coaches who can take your skills
												to the next level, regardless of your level of expertise.
											</p>
										</div>
									</div>
								</div>
								...
								<div className="row align-items-center">
									...
									<div className="col-sm-9 col-9">
										<div className="hgh-features-captions py-3 pe-3">
											...
											<p className="m-0">
												Stay ahead of the game with up-to-date event listings, allowing you to
												participate in thrilling tournaments and marathons or be a part of the
												cheering crowd.
											</p>
										</div>
									</div>
