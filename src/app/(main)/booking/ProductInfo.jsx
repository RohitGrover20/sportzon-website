        ...
        <div className="col-xl-4 col-lg-4 col-lg-offset-1">
            <div className="border gray-simple rounded">
                <div className='bg-primary py-3 px-3 rounded-top'>
                    <h5 className="pb-0 text-white"
                        style={{ fontWeight: "normal" }}
                    >{venue && venue.title}</h5>
                            ...
                            <Form>
                                <div className="row g-4  pb-md-3  mb-md-1 align-items-center mt-2 px-3 ">
                                    <div className="col-sm-4">
                                        <label className="form-label"><strong>Activity</strong></label>
                                    </div>
                                    ...
                                    <div className="col-sm-8">
                                        ...
                                        >
                                            ...
                                            {courts && courts.filter((el) => el.activity == values.activity).map((item, index) => {
                                                return (
                                                    <option key={index} value={item.slug}>{item.title} - Rs.{item.pricing}</option>
                                                )
                                            })}
                                        </Field>
                                    </div>
                                    ...
                                    <div className="col-sm-12 mb-0 pb-0">
                                        <label className="form-label"><strong>Slots</strong></label>
                                    </div>
