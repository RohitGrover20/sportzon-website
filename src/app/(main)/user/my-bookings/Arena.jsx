		...
		<div>
			{bookings &&
				bookings.map((booking, index) => {
					return (
						<div className="sng-ord border rounded-3 mb-4 px-3 py-3" key={index}>
							<a
							...
							>
								...
								<div className="flex-ord-end ps-3">
									...
									<p className="m-0 text-muted">
										Booked at - {booking.createdAt && new Date(booking.createdAt).toLocaleString()}
									</p>
								</div>
							</a>
								...
								<div className="card card-body">
									...
									<p className="mb-1">
										...
										<span className="text-dark fw-medium ms-3">
											#{booking && booking.orderId && booking.orderId.substring(6, 35)}
										</span>
									</p>
