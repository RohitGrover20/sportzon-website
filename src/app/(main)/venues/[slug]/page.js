                        ...
                        <div className="col-xl-8 col-lg-8 col-md-12 p-0">
                            ...
                            <div className="d-flex flex-wrap align-items-center justify-content-between border-bottom mb-4">
                                <div className="d-flex align-items-center mb-4 me-4">
                                    <span className="fs-sm me-2">{venue && venue.city}, {venue && venue.state}</span>
                                    <span><i className='fa fa-star text-warning' /> {venue && venue.rating}</span>
                                    <a
                            ...
                            <div className="row">
                                <div className="col-xl-12 col-lg-12 col-md-12 px-0" id="venuebyslug-slider">
                                    {venue && venue.gallery && venue.gallery.map((item, index) => {
                                        return (
                                            <div className="single-items"
                                            >
                                                <img className="img-fluid" src={`${config.API_URL}/venue/${item}`}
                            ...
                            <div className="card card-body border shadow-sm mt-4">
                                ...
                                <ul className="row gx-3 gy-4 p-0 my-1 mt-0">
                                    {venue && venue.activities && venue.activities.map((item, index) => {
                                        return (
                                            <li className="font--medium col-xl-3 col-lg-3 col-3">
                            ...
                            <div className="card card-body border shadow-sm mt-4">
                                ...
                                {/* <span className="fs-sm text-muted">4 days ago</span> */}
                                <ul className="row gx-3 gy-4 p-0 my-1 mt-0">
                                    {venue && venue.amenities && venue.amenities.map((item, index) => {
                                        return (
                                            <li className="font--medium col-xl-3 col-lg-3 col-3">
                                                <span className="square--30 circle d-inline-flex align-items-center justify-content-center text-success bg-light-success me-2">
                                                    <i className="fa-solid fa-check" />
                            ...
                            <div className="blogs-sidewraps pt-lg-0 pt-4">
                                <div className="blogs-sides">
                                    ...
                                    <div className="card card-body border">
                                        ...
                                        <p className="fs-6 pt-2 pt-sm-3">
                                            <strong>Opens At <span className='text-success'>{venue && venue.timing && venue.timing.open}</span></strong>
                                            <strong className='ms-3'>Closes At <span className='text-danger'>{venue && venue.timing && venue.timing.close}</span></strong>
                                        </p>
                                    </div>
                                    <div className="card card-body border mt-4">
                                        ...
                                        <div className="gmap_canvas">
                                            <iframe
                                                ...
                                                // marginHeight={0}
                                                // marginWidth={0}
                                                src={`https://maps.google.com/maps?height=200&hl=en&q=${venue && venue.address}&t=p&z=14&ie=UTF8&iwloc=B&output=embed`}
                                            />
                                        </div>
                                    </div>
