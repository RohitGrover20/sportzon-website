						...
						<div className="col-xl-8 col-lg-8 col-md-12">
							...
							<div className="d-lg-flex flex-wrap align-items-center justify-content-between border-bottom mb-4">
								<div className="d-lg-flex align-items-center mb-4 me-4">
									...
									<span>
										<i className="fa fa-star text-warning" /> {venue && venue.rating}
									</span>
								...
								<ul className="row gx-3 gy-4 p-0 my-1 mt-0">
									{venue &&
										...
										venue.activities.map((item, index) => {
											return (
												<li className="font--medium col-xl-3 col-lg-3 " key={index}>
							...
							<div className="card card-body border-0 bg-light mt-4">
								...
								<p className="fs-6 pt-2 pt-sm-3">{venue && venue.description}</p>
							</div>
						</div>
							...
							<div className="blogs-sidewraps pt-lg-0 pt-4">
								<div className="blogs-sides">
									...
									<div className="card card-body border mt-4">
										...
										<p className="fs-6 pt-2 pt-sm-3">{venue && venue.address}</p>
