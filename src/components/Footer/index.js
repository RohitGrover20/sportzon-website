						...
						<div className="row">
							<div className="col-lg-3 col-md-4">
								<div className="footer-widget mt-3">
									<img src="/assets/img/logo/colored.png" className="img-footer" alt="" />
							...
							<div className="col-lg-2 col-md-4">
								<div className="footer-widget">
									...
									<ul className="footer-menu">
										...
										<li>
											<Link href="/offering-for-schools">Offering for Schools</Link>
										</li>
										<li>
											<Link href="/offering-for-corporates">Offering for Corporates</Link>
										</li>
									</ul>
								</div>
							</div>
							<div className="col-lg-2 col-md-4">
								<div className="footer-widget">
									...
									<ul className="footer-menu">
										<li>
											<a href="http://resource.sportzon.in/news-events">News & Events</a>
										</li>
										<li>
											<a href="http://resource.sportzon.in/blogs">Blogs</a>
										</li>
										<li>
											<a href="http://resource.sportzon.in/media-gallery">Media & Gallery</a>
										</li>
										{/* <li>
                      <a href="##">Affiliate Program</a>
                    </li> */}
										<li>
											<a href="http://resource.sportzon.in/help-support">Help &amp; Support</a>
										</li>
									</ul>
								</div>
							</div>
							...
							<div className="col-lg-3 col-md-6">
								<div className="footer-widget">
									...
									<div className="app-wrap">
										<p>
											<a href="/">
												<img src="/assets/img/light-play.png" className="img-fluid" alt="" />
											</a>
										</p>
										<p>
											<a href="/">
												<img src="/assets/img/light-ios.png" className="img-fluid" alt="" />
											</a>
										</p>
									</div>
								</div>
					...
					<div className="container">
						<div className="row align-items-center justify-content-between">
							<div className="col-xl-4 col-lg-5 col-md-5">
								<p className="mb-0">
									Citiskape Sports Pvt. Ltd. © 2023 Sportzon® Design by Yesteq Ventures.
								</p>
							</div>
